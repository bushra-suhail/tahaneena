...
@section('css')
<link rel="stylesheet" href="{{ asset('webasset/assets/card10/index.css') }}" />
...
@section('content')
        ...
        <div id="div" class="card-container">
            <div class="right-section">
              ...
              <p class="title-main">
                <span class="title1">congratulations</span><br />
                <br>
                <br>
                <br>
                <br>
              ...
              <textarea
                placeholder="Lorem ipsum dolor sit amet consectetur hfh
                 adipisicing elit.
                 Maximemollitia, molestiae quas vel sint commodi repudiandae consequuntur"
