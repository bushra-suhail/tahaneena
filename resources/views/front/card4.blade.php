...
@section('css')
<link rel="stylesheet" href="{{ asset('webasset/assets/card4/index.css') }}" />
        ...
        <div class="section">
            <div class="container">
                ...
                <div class="page-banner-title">
                    <h2 class="title">Mother Day Greeting</h2>
                    {{-- <p style="margin-bottom: 46px">Mother Day Greeting Card</p> --}}
                </div>
